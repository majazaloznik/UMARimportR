...
-- ============================================================================
CREATE OR REPLACE FUNCTION platform.insert_new_dimension_levels(tab_dim_id BIGINT,
                                            level_value TEXT,
                                            level_text TEXT,
                                            OUT count INTEGER)
AS $$
...
-- ============================================================================
CREATE OR REPLACE FUNCTION platform.insert_new_series(table_id bigint,
                                            name_long TEXT,
                                            unit_id INTEGER,
                                            code TEXT,
                                            interval_id TEXT,
...
-- ============================================================================
CREATE OR REPLACE FUNCTION platform.insert_new_series_levels(series_id BIGINT,
                                            tab_dim_id BIGINT,
                                            level_value TEXT,
                                            OUT count INTEGER)
AS $$
...
-- ============================================================================
CREATE OR REPLACE FUNCTION platform.insert_new_table_dimensions(table_id BIGINT,
                                            dimension TEXT,
                                            is_time BOOLEAN,
                                            OUT count INTEGER)
AS $$
...
-- ============================================================================
CREATE OR REPLACE FUNCTION platform.insert_new_vintage(series_id BIGINT,
                                            published TIMESTAMP,
                                            OUT count INTEGER)
AS $$
BEGIN
